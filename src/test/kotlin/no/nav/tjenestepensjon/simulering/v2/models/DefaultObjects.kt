...
import no.nav.tjenestepensjon.simulering.v2.models.response.HentStillingsprosentListeResponse
import no.nav.tjenestepensjon.simulering.v2.models.response.SimulerOffentligTjenestepensjonResponse
import no.nav.tjenestepensjon.simulering.v2.models.response.SimulertPensjon
...
const val defaultPackageXML = """xmlns:ns2="http://nav.no/ekstern/pensjon/tjenester/tjenestepensjonSimulering/v2"""
...
const val defaultStillingsprosentXML = """<datoFom>$defaultFomDateXML</datoFom><datoTom>$defaultTomDateXML</datoTom><stillingsprosent>0.0</stillingsprosent><aldersgrense>0</aldersgrense><faktiskHovedlonn>bogus</faktiskHovedlonn><stillingsuavhengigTilleggslonn>bogus</stillingsuavhengigTilleggslonn>"""
...
const val defaultHentStillingsprosentListeResponseXML = """$defaultXMLMetadata<ns2:hentStillingsprosentListeResponse $defaultPackageXML"><response><stillingsprosentListe><datoFom>$defaultFomDateXML</datoFom><datoTom>$defaultTomDateXML</datoTom><stillingsprosent>0.0</stillingsprosent><aldersgrense>0</aldersgrense><faktiskHovedlonn>bogus</faktiskHovedlonn><stillingsuavhengigTilleggslonn>bogus</stillingsuavhengigTilleggslonn></stillingsprosentListe></response></ns2:hentStillingsprosentListeResponse>"""
