...
public final class JwkTokenStore implements TokenStore {
    ...
    /**
     * Creates a new instance using the provided {@link TokenProvider} as the location for the JWK Sets
     ...
     */
    public JwkTokenStore(List<TokenProvider> tokenProviders, AccessTokenConverter accessTokenConverter, JwtClaimsSetVerifier jwtClaimsSetVerifier) {

        JwkDefinitionSource jwkDefinitionSource = new JwkDefinitionSource(tokenProviders);
