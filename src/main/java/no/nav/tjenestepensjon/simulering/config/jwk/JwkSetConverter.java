...
import static no.nav.tjenestepensjon.simulering.config.jwk.JwkAttributes.ALGORITHM;
import static no.nav.tjenestepensjon.simulering.config.jwk.JwkAttributes.EC_PUBLIC_KEY_CURVE;
import static no.nav.tjenestepensjon.simulering.config.jwk.JwkAttributes.EC_PUBLIC_KEY_X;
import static no.nav.tjenestepensjon.simulering.config.jwk.JwkAttributes.EC_PUBLIC_KEY_Y;
import static no.nav.tjenestepensjon.simulering.config.jwk.JwkAttributes.KEYS;
import static no.nav.tjenestepensjon.simulering.config.jwk.JwkAttributes.KEY_ID;
import static no.nav.tjenestepensjon.simulering.config.jwk.JwkAttributes.KEY_TYPE;
import static no.nav.tjenestepensjon.simulering.config.jwk.JwkAttributes.PUBLIC_KEY_USE;
import static no.nav.tjenestepensjon.simulering.config.jwk.JwkAttributes.RSA_PUBLIC_KEY_EXPONENT;
import static no.nav.tjenestepensjon.simulering.config.jwk.JwkAttributes.RSA_PUBLIC_KEY_MODULUS;
