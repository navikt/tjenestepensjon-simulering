...
object Tjenestepensjon2025Mapper {
    ...
    fun mapToVellykketTjenestepensjonSimuleringResponse(simulertTjenestepensjon: SimulertTjenestepensjon) : SimulerTjenestepensjonResponseDto {
        return SimulerTjenestepensjonResponseDto(
