...
class SecurityConfig(
    ...
    fun configure(http: HttpSecurity): DefaultSecurityFilterChain = http.run {
        ...
        authorizeHttpRequests {
            it.requestMatchers(antMatcher("/actuator/**"), antMatcher("/v2025/tjenestepensjon/ping"), antMatcher("/simulering/ping"), antMatcher("/fss/simulering/ping")).permitAll().anyRequest().authenticated()
        }
